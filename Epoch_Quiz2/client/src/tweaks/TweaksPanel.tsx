...
import type { Tweaks, SetTweakFn } from '../types';
...
export function useTweaks(defaults: Tweaks): [Tweaks, SetTweakFn] {
  const [values, setValues] = React.useState<Tweaks>(defaults);
  const setTweak = React.useCallback<SetTweakFn>((keyOrEdits, val) => {

...
const T: Record<Lang, Record<string, string>> = {
  EN: {
    ...
    'faq.timerResume.a': "That attempt ends immediately — closing, refreshing, or losing connection all count. Reopening the assessment starts a brand-new attempt from Question 1 with the timer reset; nothing is restored.",
  ...
  HI: {
    ...
    'faq.timerResume.a': 'वह प्रयास तुरंत समाप्त हो जाता है — बंद करना, रीफ्रेश करना, या कनेक्शन टूटना, सभी इसमें शामिल हैं। दोबारा खोलने पर एक नया प्रयास प्रश्न 1 से शुरू होता है और टाइमर पूरी अवधि पर रीसेट हो जाता है — कुछ भी पुनर्स्थापित नहीं होता।',
